...
if __name__ == "__main__":
    imdb_url = "https://www.imdb.com/title/tt23849204"
    movie_id = imdb_url.split('/')[-1] if imdb_url.split('/')[-1] else imdb_url.split('/')[-2]
    
    print(f"Fetching movie info for {movie_id}...")
    movie_info = get_movie_info(imdb_url)
